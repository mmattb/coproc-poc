...
\begin{figure}
	...
	\caption{Lesion designs which prevent forward propagation of object shape information
	         differentially impact hand pose. Loss here is a mean squared error (MSE) loss,
...
to effectively bridge across the lesion, forward propatating the object shape information,
indirectly, through the use of stimulation.

In our experiments below, we demonstrate our co-processor design on two types of
simulated lesions:
\begin{itemize}
	...
	\item \textbf{Output-based:} we force the output of some proportion of ``M1'' neurons
	      to zero, effectively removing them from the network.
\end{itemize}

TODO: show example trajectories for both

\subsubsection{Simulated network exhibits long running dynamics}
Just as the co-processor must adapt to 
