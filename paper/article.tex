...
lesioned. In the coadaptive case, the co-processor needs to adapt to
...
simulated recovery. The co-processor in this later phase of training is
tasked with adapting to the non-stationarity that results from the recovery
process, which it does successfully.
...
co-processor to perform that forward-propagation.
...
F5 modules. As a result, this experiment primarily demonstrates that the
...
Note that the object class separation metric $S$ returned to
a healthy value towards the end of the training, indicating that the
learned solution did not simply refine the stereotyped grasp.
