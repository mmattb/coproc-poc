...
allowing for an AI agent to learn stimulation policies that improve a user's task performance.
The central notion of the design is to leverage a stimulation model, whose purpose is to provide
training feedback to an AI agent responsible for generating the stimulation. We present here
a first demonstration of the learning algorithms and key properties

We proposed X
It did Y
It was found that Z
It has potential to A
